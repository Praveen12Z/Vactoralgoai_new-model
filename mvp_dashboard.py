...
def run_mvp_dashboard():
    ...
    # -----------------------------------------------------------------
    # ACCESS: Website handles signup. MVP runs in public / gated mode.
    # -----------------------------------------------------------------
    user_email = "public"
    st.caption("Early Access MVP • Signup happens on the website • Accounts & saving will come in the full launch.")
    ...
    user_strategies = []  # saving disabled in MVP public mode
    ...
    with col1:
        ...
        # Saved strategies selector (disabled in MVP public mode)
